 ...
 * You may define this constant in the bootstrap script. The value could be 'prod' (production), 'dev' (development), 'local' (virtual machine), etc.
 */
...
/**
 * Whether the the application is running in local environment.
 */
defined('APP_ENV_DEV') or define('APP_ENV_DEV', APP_ENV === 'local');
 ...
 * 
 * Based on current environment, this will look for one of the following:
 * - settings.local.php
 * - settings.dev.php
 * - settings.prod.php
 */
$environmentSettingsFilePath = $app_root . '/' . $site_path . '/settings.' . APP_ENV . '.php';
if (file_exists($environmentSettingsFilePath)) {
  include $environmentSettingsFilePath;
}
