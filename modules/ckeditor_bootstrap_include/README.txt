...
4. To change some options please see vertical tab of this module on this page.
...
You can easely turn the filters off by turning off the checkbox "Limit allowed HTML tags and correct faulty HTML"
in the text format options (right after the vertical tabs).