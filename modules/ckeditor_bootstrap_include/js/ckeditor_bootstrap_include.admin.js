...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.behaviors.ckeditor_bootstrap_includeSettingsSummary = {
    attach: function () {
      $('[data-ckeditor-plugin-id="jsplus_bootstrap_include"]').drupalSetSummary(function (context) {
        return 'Bootstrap Tools include options';
      });
      $('head').append('<style>' +
          ...
          '</style>')
      $('details[data-ckeditor-plugin-id=jsplus_bootstrap_include] [data-url-help]').each(
          function() {
      ...
      $('details[data-ckeditor-plugin-id=jsplus_bootstrap_include] [data-param-priority]').each(
          function() {
