...
(function ($, Drupal, drupalSettings) {
  ...
  Drupal.behaviors.ckeditor_bootstrap_toolsSettingsSummary = {
    attach: function () {
      $('[data-ckeditor-plugin-id="jsplus_bootstrap_tools"]').drupalSetSummary(function (context) {
        return 'All JS+ Bootstrap Tools add-ons configuration';
      });
      $('head').append('<style>' +
          ...
          '</style>')
      $('details[data-ckeditor-plugin-id=jsplus_bootstrap_tools] [data-url-help]').each(
          function() {
      ...
      $('details[data-ckeditor-plugin-id=jsplus_bootstrap_tools] [data-param-priority]').each(
          function() {
